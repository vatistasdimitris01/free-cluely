...
interface ElectronAPI {
  ...
  webSearch: (query: string) => Promise<Array<{ title: string; link: string; snippet: string }>>
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  switchToGemini: (model?: string, apiKey?: string) => ipcRenderer.invoke("switch-to-gemini", model, apiKey),
